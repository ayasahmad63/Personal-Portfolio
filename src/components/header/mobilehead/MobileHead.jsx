    ...
    return (
        <div className="MobileHead">
            ...
            <div className="mob-options">
                ...
                <div className="name">
                    <a className="mobile-anchor" href="#About">
                ...
                <div className="mob-option">
                    ...
                    <div className="name">
                    <a className="mobile-anchor" href="#Skill">
                ...
                <div className="mob-option">
                    ...
                    <div className="name">
                    <a className="mobile-anchor" href="#Project">
                        <h4>Projects</h4>
                    </a>
                    </div>
                </div>
                <div className="mob-option">
                    ...
                    <div className="name"><a className="mobile-anchor" href="#Contact">
                        <h4>Contact Me</h4>
                    </a>
                    </div>
                </div>
